      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-md p-8">
        ...
        <div className="space-y-8 text-gray-700">
          ...
          <section>
            ...
            <p className="mb-4">
              In no event shall ReplySystem or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on ReplySystem, even if ReplySystem or an authorized representative has been notified orally or in writing of the possibility of such damage.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              The materials appearing on ReplySystem could include technical, typographical, or photographic errors. ReplySystem does not warrant that any of the materials on the platform are accurate, complete, or current. ReplySystem may make changes to the materials contained on the platform at any time without notice.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              ReplySystem has not reviewed all of the sites linked to its website and is not responsible for the contents of any such linked site. The inclusion of any link does not imply endorsement by ReplySystem of the site. Use of any such linked website is at the user's own risk.
            </p>
          </section>
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">9. User Accounts</h2>
            <p className="mb-4">
              When you create an account on ReplySystem, you are responsible for maintaining the confidentiality of your account information and password. You are responsible for all activities that occur under your account. You agree to:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">10. Prohibited Conduct</h2>
            <p className="mb-4">
              You agree not to engage in any of the following activities:
            </p>
            <ul className="list-disc pl-6 space-y-2 mb-4">
              <li>Harassing or causing distress to others through the platform</li>
          ...
          <section>
            ...
            <p className="mb-4">
              All content on ReplySystem, including text, graphics, logos, images, and software, is the property of ReplySystem or its content suppliers and is protected by international copyright laws. You may not reproduce, distribute, or transmit any content without our prior written permission.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mb-4">
              ReplySystem may terminate or suspend your account and access to the Service immediately, without prior notice or liability, if you breach any terms of this agreement or engage in any conduct that ReplySystem deems harmful or inappropriate.
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">14. Liability Limitation</h2>
            <p className="mb-4">
              To the fullest extent permitted by applicable law, ReplySystem shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or any loss of profits or revenues (whether incurred directly or indirectly), arising out of your use of or inability to use the Service.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-100 p-4 rounded">
              ...
              <p>Email: support@replysys.com</p>
